...
- Verificar que la app está corriendo: `curl http://localhost:8080/actuator/health`
- URL correcta: `http://localhost:8080/h2-console`
- JDBC URL: `jdbc:h2:mem:solicitudesdb`
- Username: `hectorsum` - Password: *(vacío)*
...
### docker-compose puerto en uso
```bash
# Ver qué usa el puerto
lsof -i :8080
# O cambiar el puerto en docker-compose.yml
ports:
  - "8090:8080"  # exponer en 8090 en lugar de 8080
```

### `Content-Type not supported` en POST/PUT
Asegurarte de enviar `Content-Type: application/json` en el header. El endpoint no acepta `application/x-www-form-urlencoded`.

![Diagrama de capas](docs/application-json.png)